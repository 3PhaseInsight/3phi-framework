...
class TopologyCleaner(BaseDataApp):
    ...
    # The cleaner always works on the current topology version — no config keys
    # affect its output, so the workflow name stays unscoped.
    WORKFLOW = "topology_cleaning"
